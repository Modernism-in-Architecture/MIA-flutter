              ...
              children: [
                ...
                Row(
                    children: [
                      ...
                      if (snapshot.data!.birthPlace.isNotEmpty || snapshot.data!.birthCountry.isNotEmpty) const Text(" in ", style: const TextStyle(fontSize: 16)),
                ...
                Row(
                    children: [
                      ...
                      if (snapshot.data!.deathPlace.isNotEmpty || snapshot.data!.deathCountry.isNotEmpty) const Text(" in ", style: const TextStyle(fontSize: 16)),
